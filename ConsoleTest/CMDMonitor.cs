...
public class CMDMonitor
{
    ...
    public void StartMonitoring()
    {
        try
        {
            ...
            Console.WriteLine("CMD Monitoring started.");
        }
        catch (Exception ex)
        {
            Console.WriteLine($"Error during CMD monitoring start: {ex.Message}");
        }
    }
    ...
    public void StopMonitoring()
    {
        try
        {
            ...
            Console.WriteLine("CMD Monitoring stopped.");
        }
        catch (Exception ex)
        {
            Console.WriteLine($"Error during CMD monitoring stop: {ex.Message}");
        }
    }
}
